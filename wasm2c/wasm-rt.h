...
#if (WASM_RT_MEMCHECK_GUARD_PAGES + WASM_RT_MEMCHECK_BOUNDS_CHECK + WASM_RT_MEMCHECK_BOUNDS_CHECK_ASM + \
...
#elif (WASM_RT_MEMCHECK_GUARD_PAGES + WASM_RT_MEMCHECK_BOUNDS_CHECK + WASM_RT_MEMCHECK_BOUNDS_CHECK_ASM + \
