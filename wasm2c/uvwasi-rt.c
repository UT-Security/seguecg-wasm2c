...
uint32_t w2c_wasi__snapshot__preview1_fd_prestat_get(w2c_wasi__snapshot__preview1* wp, uint32_t fd, wasm_ptr buf)
{
...
uint32_t w2c_wasi__snapshot__preview1_fd_prestat_dir_name(w2c_wasi__snapshot__preview1* wp, uint32_t fd, wasm_ptr path, uint32_t path_len)
{
    uvwasi_errno_t ret = uvwasi_fd_prestat_dir_name(wp->uvwasi, fd, (char*)MEMACCESS(path), path_len);
    return ret;
}

uint32_t w2c_wasi__snapshot__preview1_environ_sizes_get(w2c_wasi__snapshot__preview1* wp, wasm_ptr env_count, wasm_ptr env_buf_size)
{
...
uint32_t w2c_wasi__snapshot__preview1_environ_get(w2c_wasi__snapshot__preview1* wp, wasm_ptr env, wasm_ptr buf)
{
    uvwasi_size_t uvcount;
    uvwasi_size_t uvbufsize;
    uvwasi_errno_t ret;
...
uint32_t w2c_wasi__snapshot__preview1_args_sizes_get(w2c_wasi__snapshot__preview1* wp, wasm_ptr argc, wasm_ptr argv_buf_size)
{
    uvwasi_size_t uvcount;
    uvwasi_size_t uvbufsize;
...
uint32_t w2c_wasi__snapshot__preview1_args_get(w2c_wasi__snapshot__preview1* wp, wasm_ptr argv, wasm_ptr buf)
{
    uvwasi_size_t uvcount;
    uvwasi_size_t uvbufsize;
    uvwasi_errno_t ret;
...
uint32_t w2c_wasi__snapshot__preview1_fd_fdstat_get(w2c_wasi__snapshot__preview1* wp, uint32_t fd, wasm_ptr stat)
{
...
uint32_t w2c_wasi__snapshot__preview1_fd_fdstat_set_flags(w2c_wasi__snapshot__preview1* wp, uint32_t fd, uint32_t flags)
{
    uvwasi_errno_t ret = uvwasi_fd_fdstat_set_flags(wp->uvwasi, fd, flags);
    return ret;
}

uint32_t w2c_wasi__snapshot__preview1_fd_fdstat_set_rights(w2c_wasi__snapshot__preview1* wp, uint32_t fd, uint64_t fs_rights_base, uint64_t fs_rights_inheriting)
{
    uvwasi_errno_t ret = uvwasi_fd_fdstat_set_rights(wp->uvwasi, fd, fs_rights_base, fs_rights_inheriting);
    return ret;
}

uint32_t w2c_wasi__snapshot__preview1_path_filestat_set_times(w2c_wasi__snapshot__preview1* wp, uint32_t fd, uint32_t flags, wasm_ptr path, uint32_t path_len, uint64_t atim, uint64_t mtim, uint32_t fst_flags)
{
    uvwasi_errno_t ret = uvwasi_path_filestat_set_times(wp->uvwasi, fd, flags, (char*)MEMACCESS(path), path_len, atim, mtim, fst_flags);
    return ret;
}

uint32_t w2c_wasi__snapshot__preview1_path_filestat_get(w2c_wasi__snapshot__preview1* wp, uint32_t fd, uint32_t flags, wasm_ptr path, uint32_t path_len, wasm_ptr stat)
{
...
uint32_t w2c_wasi__snapshot__preview1_fd_filestat_get(w2c_wasi__snapshot__preview1* wp, uint32_t fd, wasm_ptr stat)
{
    uvwasi_filestat_t uvstat;
...
uint32_t w2c_wasi__snapshot__preview1_fd_seek(w2c_wasi__snapshot__preview1* wp, uint32_t fd, uint64_t offset, uint32_t wasi_whence, wasm_ptr pos)
{
...
uint32_t w2c_wasi__snapshot__preview1_fd_tell(w2c_wasi__snapshot__preview1* wp, uint32_t fd, wasm_ptr pos)
{
    uvwasi_filesize_t uvpos;
...
uint32_t w2c_wasi__snapshot__preview1_fd_filestat_set_size(w2c_wasi__snapshot__preview1* wp, uint32_t fd, uint64_t filesize)
{
    uvwasi_errno_t ret = uvwasi_fd_filestat_set_size(wp->uvwasi, fd, filesize);
    return ret;
}

uint32_t w2c_wasi__snapshot__preview1_fd_filestat_set_times(w2c_wasi__snapshot__preview1* wp, uint32_t fd, uint64_t atim, uint64_t mtim, uint32_t fst_flags)
{
...
uint32_t w2c_wasi__snapshot__preview1_fd_sync(w2c_wasi__snapshot__preview1* wp, uint32_t fd)
{
    uvwasi_errno_t ret = uvwasi_fd_sync(wp->uvwasi, fd);
    return ret;
}

uint32_t w2c_wasi__snapshot__preview1_fd_datasync(w2c_wasi__snapshot__preview1* wp, uint32_t fd)
{
    uvwasi_errno_t ret = uvwasi_fd_datasync(wp->uvwasi, fd);
    return ret;
}

uint32_t w2c_wasi__snapshot__preview1_fd_renumber(w2c_wasi__snapshot__preview1* wp, uint32_t fd_from, uint32_t fd_to)
{
...
uint32_t w2c_wasi__snapshot__preview1_fd_allocate(w2c_wasi__snapshot__preview1* wp, uint32_t fd, uint64_t offset, uint64_t len)
{
    uvwasi_errno_t ret = uvwasi_fd_allocate(wp->uvwasi, fd, offset, len);
    return ret;
}

uint32_t w2c_wasi__snapshot__preview1_fd_advise(w2c_wasi__snapshot__preview1* wp, uint32_t fd, uint64_t offset, uint64_t len, uint32_t advice)
{
    uvwasi_errno_t ret = uvwasi_fd_advise(wp->uvwasi, fd, offset, len, advice);
    return ret;
}

uint32_t w2c_wasi__snapshot__preview1_path_open(w2c_wasi__snapshot__preview1* wp, uint32_t dirfd, uint32_t dirflags,
...
uint32_t w2c_wasi__snapshot__preview1_fd_close(w2c_wasi__snapshot__preview1* wp, uint32_t fd)
{
    uvwasi_errno_t ret = uvwasi_fd_close(wp->uvwasi, fd);
    return ret;
}

uint32_t w2c_wasi__snapshot__preview1_path_symlink(w2c_wasi__snapshot__preview1* wp, wasm_ptr old_path, uint32_t old_path_len,
...
uint32_t w2c_wasi__snapshot__preview1_path_rename(w2c_wasi__snapshot__preview1* wp, uint32_t old_fd, wasm_ptr old_path,
...
uint32_t w2c_wasi__snapshot__preview1_path_link(w2c_wasi__snapshot__preview1* wp, uint32_t old_fd, uint32_t old_flags,
...
uint32_t w2c_wasi__snapshot__preview1_path_unlink_file(w2c_wasi__snapshot__preview1* wp, uint32_t fd, wasm_ptr path, uint32_t path_len)
{
    uvwasi_errno_t ret = uvwasi_path_unlink_file(wp->uvwasi, fd, (char*)MEMACCESS(path), path_len);
    return ret;
}

uint32_t w2c_wasi__snapshot__preview1_path_readlink(w2c_wasi__snapshot__preview1* wp, uint32_t fd, wasm_ptr path, uint32_t path_len, wasm_ptr buf, uint32_t buf_len, wasm_ptr bufused)
{
...
uint32_t w2c_wasi__snapshot__preview1_path_create_directory(w2c_wasi__snapshot__preview1* wp, uint32_t fd, wasm_ptr path, uint32_t path_len)
{
    uvwasi_errno_t ret = uvwasi_path_create_directory(wp->uvwasi, fd, (char*)MEMACCESS(path), path_len);
    return ret;
}

uint32_t w2c_wasi__snapshot__preview1_path_remove_directory(w2c_wasi__snapshot__preview1* wp, uint32_t fd, wasm_ptr path, uint32_t path_len)
{
    uvwasi_errno_t ret = uvwasi_path_remove_directory(wp->uvwasi, fd, (char*)MEMACCESS(path), path_len);
    return ret;
}

uint32_t w2c_wasi__snapshot__preview1_fd_readdir(w2c_wasi__snapshot__preview1* wp, uint32_t fd, wasm_ptr buf, uint32_t buf_len, uint64_t cookie, wasm_ptr bufused)
{
    uvwasi_size_t uvbufused;
...
uint32_t w2c_wasi__snapshot__preview1_fd_write(w2c_wasi__snapshot__preview1* wp, uint32_t fd, wasm_ptr iovs_offset, uint32_t iovs_len, wasm_ptr nwritten)
{
...
uint32_t w2c_wasi__snapshot__preview1_fd_pwrite(w2c_wasi__snapshot__preview1* wp, uint32_t fd, wasm_ptr iovs_offset, uint32_t iovs_len, uint64_t offset, wasm_ptr nwritten)
{
    wasi_iovec_t * wasi_iovs = (wasi_iovec_t *)MEMACCESS(iovs_offset);
...
uint32_t w2c_wasi__snapshot__preview1_fd_read(w2c_wasi__snapshot__preview1* wp, uint32_t fd, wasm_ptr iovs_offset, uint32_t iovs_len, wasm_ptr nread)
{
    wasi_iovec_t * wasi_iovs = (wasi_iovec_t *)MEMACCESS(iovs_offset);
...
uint32_t w2c_wasi__snapshot__preview1_fd_pread(w2c_wasi__snapshot__preview1* wp, uint32_t fd, wasm_ptr iovs_offset, uint32_t iovs_len, uint64_t offset, wasm_ptr nread)
{
    wasi_iovec_t * wasi_iovs = (wasi_iovec_t *)MEMACCESS(iovs_offset);
...
uint32_t w2c_wasi__snapshot__preview1_poll_oneoff(w2c_wasi__snapshot__preview1* wp, wasm_ptr in, wasm_ptr out, uint32_t nsubscriptions, wasm_ptr nevents)
{
...
uint32_t w2c_wasi__snapshot__preview1_clock_res_get(w2c_wasi__snapshot__preview1* wp, uint32_t clk_id, wasm_ptr result)
{
...
uint32_t w2c_wasi__snapshot__preview1_clock_time_get(w2c_wasi__snapshot__preview1* wp, uint32_t clk_id, uint64_t precision, wasm_ptr result)
{
    uvwasi_timestamp_t t;
...
uint32_t w2c_wasi__snapshot__preview1_random_get(w2c_wasi__snapshot__preview1* wp, wasm_ptr buf, uint32_t buf_len)
{
    uvwasi_errno_t ret = uvwasi_random_get(wp->uvwasi, MEMACCESS(buf), buf_len);
    return ret;
}

uint32_t w2c_wasi__snapshot__preview1_sched_yield(w2c_wasi__snapshot__preview1* wp)
{
    uvwasi_errno_t ret = uvwasi_sched_yield(wp->uvwasi);
    return ret;
}

uint32_t w2c_wasi__snapshot__preview1_proc_raise(w2c_wasi__snapshot__preview1* wp, uint32_t sig)
{
    uvwasi_errno_t ret = uvwasi_proc_raise(wp->uvwasi, sig);
    return ret;
}

void w2c_wasi__snapshot__preview1_proc_exit(w2c_wasi__snapshot__preview1* wp, uint32_t code)
{
...
STUB_IMPORT_IMPL(uint32_t,
                 ...
                 (w2c_wasi__snapshot__preview1* wp, uint32_t a, uint32_t b, uint32_t c),
                 WASI_DEFAULT_ERROR);
STUB_IMPORT_IMPL(uint32_t,
                 w2c_wasi__snapshot__preview1_sock_recv,
                 (w2c_wasi__snapshot__preview1* wp, uint32_t a, uint32_t b, uint32_t c, uint32_t d, uint32_t e, uint32_t f),
                 WASI_DEFAULT_ERROR);
STUB_IMPORT_IMPL(uint32_t,
                 w2c_wasi__snapshot__preview1_sock_send,
                 (w2c_wasi__snapshot__preview1* wp, uint32_t a, uint32_t b, uint32_t c, uint32_t d, uint32_t e),
                 WASI_DEFAULT_ERROR);
STUB_IMPORT_IMPL(uint32_t,
                 w2c_wasi__snapshot__preview1_sock_shutdown,
                 (w2c_wasi__snapshot__preview1* wp, uint32_t a, uint32_t b),
                 WASI_DEFAULT_ERROR);