...
// Specify defaults for memory checks if unspecified
    ...
    !defined(WASM_RT_MEMCHECK_SHADOW_BYTES_BITSCAN) && \
    ...
    !defined(WASM_RT_MEMCHECK_SSWRITE_SIM)
...
#endif
#ifndef WASM_RT_MEMCHECK_SHADOW_BYTES_BITSCAN
#define WASM_RT_MEMCHECK_SHADOW_BYTES_BITSCAN 0
#endif
...
#endif
#ifndef WASM_RT_MEMCHECK_SSWRITE_SIM
#define WASM_RT_MEMCHECK_SSWRITE_SIM 0
#endif
...
#if !defined(WASM_RT_MEMCHECK_SHADOW_BYTES_BITSCAN_SCHEME) || \
    WASM_RT_MEMCHECK_SHADOW_BYTES_BITSCAN_SCHEME < 1 ||       \
    WASM_RT_MEMCHECK_SHADOW_BYTES_BITSCAN_SCHEME > 2
#error "Expected value for WASM_RT_MEMCHECK_SHADOW_BYTES_BITSCAN_SCHEME between 1 and 2"
#endif
#endif
     ...
     WASM_RT_MEMCHECK_SHADOW_BYTES + WASM_RT_MEMCHECK_SHADOW_BYTES_TAG + WASM_RT_MEMCHECK_SHADOW_BYTES_BITSCAN + WASM_RT_MEMCHECK_PRESHADOW_BYTES + \
     WASM_RT_MEMCHECK_DEBUG_WATCH + WASM_RT_MEMCHECK_MPX + WASM_RT_MEMCHECK_DUMMY + WASM_RT_MEMCHECK_DUMMY2  + WASM_RT_MEMCHECK_DUMMY3 + \
     WASM_RT_MEMCHECK_MASK_PDEP + WASM_RT_MEMCHECK_MASK_PDEP48 + WASM_RT_MEMCHECK_MASK_PEXT + WASM_RT_MEMCHECK_SSWRITE_SIM) > 1
#error "Cannot use multiple memcheck schemes"
       ...
       WASM_RT_MEMCHECK_SHADOW_BYTES + WASM_RT_MEMCHECK_SHADOW_BYTES_TAG + WASM_RT_MEMCHECK_SHADOW_BYTES_BITSCAN + WASM_RT_MEMCHECK_PRESHADOW_BYTES + \
       WASM_RT_MEMCHECK_DEBUG_WATCH + WASM_RT_MEMCHECK_MPX + WASM_RT_MEMCHECK_DUMMY + WASM_RT_MEMCHECK_DUMMY2  + WASM_RT_MEMCHECK_DUMMY3 + \
       WASM_RT_MEMCHECK_MASK_PDEP + WASM_RT_MEMCHECK_MASK_PDEP48 + WASM_RT_MEMCHECK_MASK_PEXT + WASM_RT_MEMCHECK_SSWRITE_SIM) == 0
